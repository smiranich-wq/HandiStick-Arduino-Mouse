...
void loop(){
  ...
  if(!etat){
    ...
    if(!buttonScroll && buttonSelect() == 5){
      mode = -1;
      delay(250);
    }
...
int buttonSelect(){
  unsigned int valButton = analogRead(A3);

  if(valButton > 50 && valButton < 70){return 8;} // UP
  if(valButton > 140 && valButton < 160){return 2;} // DOWN
  if(valButton < 20){return 4;} // LEFT
  if(valButton > 260 && valButton < 280){return 6;} // RIGHT
  if(valButton > 540 && valButton < 570){return 5;} // SELECT
